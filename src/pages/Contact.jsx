...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_82dl15m', 'template_abxhlwr', form.current, 'th-QQ5jZnw984WVY_')
      .then((result) => {
      ...
      >
        <Box>
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            <Heading fontSize={{base: '25px', sm:'35px', md:'40', lg:'45px'}} color="#9f7aea">Get in Touch</Heading>
