    ...
    <>
      ...
      >
          ...
          <Slider {...settings} ref={(slider) => setSlider(slider)}>
            {sephora.map((card, index) => (
              <Box
                ...
                border={{base:"solid 3px #a17bea",md:'solid 5px #a17bea',lg:"solid 10px #a17bea"}}
        ...
        <Box width={{ base: "70%", lg: "45%" }} m="auto">
          ...
          <Flex m="auto" mt="15px" width="60%" justifyContent={"space-around"}>
            {techStackSephora.map((el) => (
              <Image width="40px" height={"40px"} src={el.img} alt="pro-pic" />
            ))}
          </Flex>
          <Flex
            m="auto"
      ...
      >
        ...
        <Box width={{ base: "70%", lg: "45%" }} m="auto">
          ...
          <Flex m="auto"  width={{ base: "100%", lg: "60%" }} mt="25px" justifyContent={{base:'space-between',md:"center",lg:"center"}}>
            <Link
              width={"30%"}
      ...
      >
        ...
        <Box width={{ base: "70%", lg: "45%" }} m="auto">
          ...
          <Text
            ...
            fontSize={{ base: "12px", lg: "15px" }}
          >
            StyleCraze is an online site that provides information on beauty and
            wellness for Indian women. Developed with a team member Mayank. We
            both clone this website in 5 days. We use HTML, CSS, JavaScript &
            Bootstrap to make this website.
          </Text>
          <Flex m="auto" mt="15px" width="60%" justifyContent={"space-around"}>
            {techStackStyle.map((el) => (
              <Image width="40px" height={"40px"} src={el.img} alt="pro-pic" />
            ))}
          </Flex>
          <Flex m="auto" width={{ base: "100%", lg: "60%" }} mt="25px" justifyContent={{base:'space-between' , md:"center",lg:"center"}}>
